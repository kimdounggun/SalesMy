...
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-bgGray to-white px-4 pb-12 pt-8 sm:px-6 sm:pb-16 sm:pt-10 lg:px-8 lg:pb-16 lg:pt-24">
          ...
          <div className="min-w-0 space-y-4 sm:space-y-6 lg:space-y-8">
            ...
            <SectionFade delayOrder={3}>
              <a
                ...
                className="inline-flex items-center gap-2 rounded-xl bg-accent px-6 py-3.5 text-base font-semibold text-white shadow-lg shadow-accent/25 transition active:scale-95 hover:bg-accent/90 hover:shadow-xl hover:shadow-accent/30 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 sm:px-8 sm:py-4 sm:text-lg touch-manipulation whitespace-nowrap"
              >
                내 프로필 만들기
